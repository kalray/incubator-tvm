...
if(USE_OPENCL)
  ...
  #message(STATUS "lib openCL used:"${OpenCL_LIBRARIES})
  list(APPEND TVM_RUNTIME_LINKER_LIBS "/work1/apotin/csw/kEnv/kvxtools/opt/kalray/accesscore/lib/libOpenCL.so")
  message(STATUS ${TVM_RUNTIME_LINKER_LIBS})
  message(STATUS "RUNTIME_OPENCL_SRCS used:"${RUNTIME_OPENCL_SRCS})
